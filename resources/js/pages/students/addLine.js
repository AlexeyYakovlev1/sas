...
achivBtn.addEventListener('click', () => {
	createLine(achivTable)
})

abilitiesBtn.addEventListener('click', () => {
	createLine(abilitiesTable)
})

compAchivBtn.addEventListener('click', () => {
	createLine(compAchivTable)
})

volunBtn.addEventListener('click', () => {
	createLine(volunTable)
})
